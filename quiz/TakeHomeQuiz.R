...
# everyones graphs should look unique (e.g. they should have a different titles,
# labels, color schemes, line or dot types). Think about what you want your graph 
# to look like, make it in R, save them as PDFs and email to you TA by the end of the week. 
...
# Make a bar graph with this data using the barplot() command that you used in the last lab.
# Remember to customize the graph so it looks unique and save the graph as a PDF to be email
# to your TA. 
...
# If you get super stuck you can come to either of the TAs for help but you will be asked
